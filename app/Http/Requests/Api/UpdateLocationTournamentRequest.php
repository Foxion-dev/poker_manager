...
class UpdateLocationTournamentRequest extends FormRequest
{
	...
	public function rules(): array
	{
		return [
			...
			'rake' => ['nullable', 'numeric', 'min:0'],
			'rake_type' => ['nullable', 'in:fixed,percentage'],
			'prize_distribution' => ['nullable', 'array'],
			'prize_distribution.*.place' => ['required', 'integer', 'min:1'],
			'prize_distribution.*.percentage' => ['required', 'numeric', 'min:0', 'max:100'],
