		...
		<div class="max-w-md w-full">
			<div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 space-y-6">
				<div class="text-center">
					<div class="mx-auto flex items-center justify-center h-16 w-16 rounded-full bg-gradient-to-r from-purple-500 to-indigo-600 mb-4">
					...
					<p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
						Начните отслеживать свой прогресс в покере
					</p>
				</div>
